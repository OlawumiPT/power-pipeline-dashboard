...
const getExpertAnalysisByProjectId = async (projectId) => {
  try {
...
const getTransmissionInterconnectionByProject = async (projectName) => {
  try {
    const schema = process.env.DB_SCHEMA || 'pipeline_dashboard';
...
const getTransmissionInterconnectionByProjectId = async (projectId) => {
  try {
    const schema = process.env.DB_SCHEMA || 'pipeline_dashboard';
...
const checkExpertAnalysisExists = async (projectName) => {
  try {
    const schema = process.env.DB_SCHEMA || 'pipeline_dashboard';
...
module.exports = {
  // Expert Analysis
  getExpertAnalysisByProjectId,
  saveExpertAnalysis,
  
  // Transmission Interconnection
  getTransmissionInterconnectionByProject,
  getTransmissionInterconnectionByProjectId,
  saveTransmissionInterconnection,
  
  // Utility
  checkExpertAnalysisExists
};
