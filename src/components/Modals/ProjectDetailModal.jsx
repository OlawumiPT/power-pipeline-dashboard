...
const ProjectDetailModal = ({ selectedProject, closeProjectDetail }) => {
  ...
  const thermalEntries = [
    {
      label: "Plant COD",
      score: detailData["Plant COD"] || detailData["Legacy COD"] || "0",
      weight: thermalWeights.unit_cod,
      displayWeight: "20%"
    },
    {
      label: "Markets",
      score: detailData["Markets"] || "0",
    ...
    },
    {
      ...
      score: cleanTransactabilityScore(detailData["Transactability Scores"]) || "0",
      weight: thermalWeights.transactability,
      displayWeight: "30%"
    },
    {
      label: "Thermal Optimization",
      score: detailData["Thermal Optimization"] || "0",
      weight: thermalWeights.thermal_optimization,
      displayWeight: "5%"
    },
    {
      label: "Environmental",
      score: detailData["Environmental Score"] || "0",
  ...
  const redevEntries = [
    {
      label: "Market",
      score: detailData["Market Score"] || "0",
      weight: redevWeights.market,
      displayWeight: "40%"
    },
    {
      label: "Infra",
      score: detailData["Infra"] || "0",
      weight: redevWeights.infra,
      displayWeight: "30%"
    },
    {
      label: "IX",
      score: detailData["IX"] || "0",
                ...
                <div className="detail-grid">
                  {detailData["Overall Project Score"] && (
                    <div className="detail-item">
                      ...
                      <span className="detail-value badge badge-green">{detailData["Overall Project Score"]}/6.0</span>
                    </div>
                  )}
                  {detailData["Thermal Operating Score"] && (
                    <div className="detail-item">
                      <span className="detail-label">Thermal Operating Score:</span>
                      <span className="detail-value badge badge-red">{detailData["Thermal Operating Score"]}/3.0</span>
                    </div>
                  )}
                  {detailData["Redevelopment Score"] && (
                    <div className="detail-item">
                      <span className="detail-label">Redevelopment Score:</span>
                      <span className="detail-value badge badge-teal">{detailData["Redevelopment Score"]}/3.0</span>
                    </div>
                  )}
