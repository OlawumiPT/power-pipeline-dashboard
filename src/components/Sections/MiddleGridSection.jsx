...
const MiddleGridSection = ({ isoData, techData, redevelopmentTypes, ISO_COLORS, TECH_COLORS }) => {
  return (
        ...
        <div className="card-body">
          <div className="chart-with-legend">
            ...
            <div className="chart-legend">
              ...
              {isoData.map((iso, idx) => (
                <div key={iso.name} className="legend-item">
          ...
          <div className="chart-with-legend">
            ...
            <div className="chart-legend">
              ...
              {techData.map((tech, idx) => (
                <div key={tech.tech} className="legend-item">
